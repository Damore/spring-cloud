...
public class UserRestTemplateClient {
	...
	public Usuario getUser(String username) {
		...
		ResponseEntity<Usuario> restExchange = oAuth2RestTemplate.exchange("http://localhost:5555/api/user/v1/user/{username}", HttpMethod.GET, null, Usuario.class, username);
